            ...
            <div class="w-full max-w-7xl mx-auto px-6 lg:px-8 overflow-x-auto">
              <div class="flex flex-col md:flex-row max-md:gap-3 items-center justify-between mb-5">
                ...
                <div class="flex items-center gap-px rounded-lg bg-gray-100 p-1">
                  <button class="rounded-lg py-2.5 px-5 text-sm font-medium text-gray-500 transition-all duration-300 hover:bg-white hover:text-blue-600">
                    Day
                  </button>
                  <button class="rounded-lg py-2.5 px-5 text-sm font-medium text-blue-600 bg-white transition-all duration-300 hover:bg-white hover:text-blue-600">
                    Week
                  </button>
                  <button class="rounded-lg py-2.5 px-5 text-sm font-medium text-gray-500 transition-all duration-300 hover:bg-white hover:text-blue-600">
                    Month
                ...
                <button class="py-2.5 pr-7 pl-5 bg-blue-600 rounded-xl flex items-center gap-2 text-base font-semibold text-white transition-all duration-300 hover:bg-blue-700">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
              ...
              <div class=" relative">
                <div class="grid grid-cols-7 border-t border-gray-200 sticky top-0 left-0 w-full">
                  ...
                  <div class="p-3.5 flex items-center justify-center text-sm font-medium  text-blue-600">
                    Jan 9
                  </div>
                  <div class="p-3.5 flex items-center justify-center text-sm font-medium  text-gray-900">
                    Jan 10
                ...
                <div class="hidden grid-cols-7 sm:grid w-full overflow-x-auto">
                  ...
                  <div class="h-32 lg:h-28 p-0.5 md:p-3.5   border-t border-gray-200 transition-all hover:bg-stone-100">
                    <div class="rounded p-1.5 border-l-2 border-blue-600 bg-purple-50">
                      <p class="text-xs font-normal text-gray-900 mb-px">
                ...
                <div class="flex sm:hidden border-t border-gray-200 items-center w-full">
                  ...
                  <div class="grid grid-cols-1 w-full">
                    <div class="w-full h-20 border-b border-gray-200 p-1.5">
                      <div class="w-full h-full rounded p-1.5 border-l-2 border-blue-600 bg-purple-50">
                        <p class="text-xs font-normal text-gray-900 mb-px">
                          Pickup the grandmother
                        </p>
                        <p class="text-xs font-semibold text-blue-600">
